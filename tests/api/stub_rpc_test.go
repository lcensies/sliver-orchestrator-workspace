...
// stubRPC satisfies rpcpb.SliverRPCClient; most methods are no-ops.
type stubRPC struct {
	getSessionsFn func() (*clientpb.Sessions, error)
	getJobsFn     func() (*clientpb.Jobs, error)
}
...
func (s *stubRPC) GetSessions(ctx context.Context, in *commonpb.Empty, opts ...grpc.CallOption) (*clientpb.Sessions, error) {
	if s.getSessionsFn != nil { return s.getSessionsFn() }
...
func (s *stubRPC) GetJobs(ctx context.Context, in *commonpb.Empty, opts ...grpc.CallOption) (*clientpb.Jobs, error) {
	if s.getJobsFn != nil { return s.getJobsFn() }
